...
> ⚠️ **Отказ от ответственности**: Результаты тестирования предназначены исключительно для исследовательских целей и не должны использоваться для принятия клинических решений без экспертной валидации.
---
